...
/**
 * GameResponseCallAdapterFactory is a Custom Retrofit CallAdapter class.
 * Adapt returns an instance of GameResponseCall class.
 */
class GameResponseCallAdapterFactory : CallAdapter.Factory() {
        ...
        return if (upperBound is ParameterizedType && upperBound.rawType == Result::class.java) {
            object : CallAdapter<Any, Call<Result<*>>> {
                ...
                override fun adapt(call: Call<Any>): Call<Result<*>> =
                    GameResponseCall(call) as Call<Result<*>>
            }
        } else {
            null
        }
