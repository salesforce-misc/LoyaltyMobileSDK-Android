...
import com.salesforce.loyalty.mobile.myntorewards.utilities.AppConstants.Companion.REFER_FRIEND_SCREEN
...
sealed class MoreScreens(val route: String) {
    ...
    object ReferFriendScreen : MoreScreens(REFER_FRIEND_SCREEN)
}
