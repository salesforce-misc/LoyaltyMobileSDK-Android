...
//        }
    ...
    fun `for promotion success resource, data must be available`()
    {
        ...
        val mockResponse =
            Gson().fromJson(MockResponseFileReader("Promotions.json").content, PromotionsResponse::class.java)
    ...
    fun `for promotion enroll success`()
    {
        ...
        val mockResponse =
            Gson().fromJson(MockResponseFileReader("EnrollmentPromotion.json").content, EnrollPromotionsResponse::class.java)
        ...
        Assert.assertEquals(PromotionEnrollmentUpdateState.PROMOTION_ENROLLMENTUPDATE_SUCCESS, myPromotionViewModel.promEnrollmentStatusLiveData.value)

        Assert.assertEquals(PromotionViewState.PromotionFetchInProgress, promoViewStates[0])
        Assert.assertEquals(PromotionViewState.PromotionsFetchSuccess, promoViewStates[1])

        Assert.assertEquals(myPromotionViewModel.membershipPromotionLiveData.value, mockPromoResponse)
    }
    ...
    fun `for promotion enroll failure`()
    {
        ...
        Assert.assertEquals(PromotionEnrollmentUpdateState.PROMOTION_ENROLLMENTUPDATE_FAILURE, myPromotionViewModel.promEnrollmentStatusLiveData.value)
    ...
    fun `for promotion UnEnroll success`()
    {
        ...
        val mockResponse =
            Gson().fromJson(MockResponseFileReader("UnenrollmentPromotion.json").content, UnenrollPromotionResponse::class.java)
    ...
    fun `for profile success resource, data must be available`()
    {
        ...
        val mockResponse =
            Gson().fromJson(MockResponseFileReader("Profile.json").content, MemberProfileResponse::class.java)
    ...
    fun `for checkout flow fetch order detail success`()
    {
        ...
        } returns Result.success(OrderDetailsResponse(OrderAttributes("test", "test"),"1234", "1233", ""))
        ...
        Assert.assertEquals(checkOutFlowViewModel.orderDetailLiveData.value, OrderDetailsResponse(OrderAttributes("test", "test"),"1234", "1233", ""))
    }
